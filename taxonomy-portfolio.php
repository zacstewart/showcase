					...
					<section>
						<div class="projects">
							<div class="right header-right sort">
								...
								Sort projects by:
								<?php if($orderby == 'date'): ?>
								<a href="?orderby=date&order=<?php echo $flip; ?>">Date</a> |
								<a href="?orderby=title&order=ASC">Name</a>
								<?php elseif($orderby == 'title'): ?>
								<a href="?orderby=date&order=DESC">Date</a> |
								<a href="?orderby=title&order=<?php echo $flip; ?>">Name</a>
								<?php else: ?>
								<a href="?orderby=date&order=DESC">Date</a> |
								<a href="?orderby=title&order=ASC">Name</a>
								<?php endif; ?>
